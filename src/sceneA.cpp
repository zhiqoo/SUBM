...
//        ofPoint point(ofMap(ofNoise(fftSmoothed[i%nBandsToGet]*0.4, ofRandom(100), ofGetFrameNum() * 0.0005), 0, 1, -ofGetWidth(), ofGetWidth()),
//                      ofMap(ofNoise(fftSmoothed[i%nBandsToGet]*0.4, ofRandom(100), ofGetFrameNum() * 0.0005), 0, 1, -ofGetWidth(), ofGetWidth()),
//                      ofMap(ofNoise(fftSmoothed[i%nBandsToGet]*0.4, ofRandom(100), ofGetFrameNum() * 0.0005), 0, 1, -ofGetWidth(), ofGetWidth()));
...
//
//                if (fftSmoothed[30]*3000 > 39) {
//                    ofSetColor(fftSmoothed[30]*3000, 255 - round(points[out_index].distance(points[in_index]))*2);
...
//        ofDrawSphere(points[i], sizes[i]*fftSmoothed[200]*10);
//    }
//    cam.end();
